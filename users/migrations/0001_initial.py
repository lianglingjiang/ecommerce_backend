    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone', models.CharField(max_length=20, unique=True, verbose_name='Mobile Phone')),
                ('gender', models.CharField(blank=True, choices=[('female', 'Female'), ('male', 'Male'), ('non-binary', 'Non-Binary'), ('other', 'Other'), ('none', 'Prefer not to Answer')], max_length=20, null=True, verbose_name='Gender')),
